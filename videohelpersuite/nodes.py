...
class VideoSaver:
    ...
    def INPUT_TYPES(s):
        ...
        return {
            "required": {
                ...
                "loop_count": ("INT", {"default": 0, "min": 0, "max": 100, "step": 1}),
                "base_directory": ("STRING",  {"default": folder_paths.get_output_directory(), }),
                "filename_prefix1": ("STRING", {"default": "AnimateDiff"}),
                "filename_prefix2": ("STRING", {"default": "Role"}),
                "format": (["image/gif", "image/webp"] + ffmpeg_formats, {'formats': format_widgets}),
    ...
    def save_video(
        ...
        latents=None,
        base_directory="",
        filename_prefix1="AnimateDiff",
        filename_prefix2="AnimateDiff",
        format="image/gif",
        save_output=True,
        prompt=None,
        extra_pnginfo=None,
        ...
        **kwargs
        ...
        directory1 = base_directory
        directory2 = os.path.join(directory1, filename_prefix1)
        directory = directory2
        prefix = filename_prefix1 + "_" + filename_prefix2
